...
export class GameService {
    ...
    private move(
        ...
        if(this.theEnd || !this.canInMove(dimX, false, reverse)){
            return;
        }
    ...
    private generateItems(lenght = 2){
    ...
    private thisIsTheEnd(){
        return !this.canInMove('row') && !this.canInMove('col');
    }

    private canInMove(dimX: 'row' | 'col', skipDir = true, forward = false){
